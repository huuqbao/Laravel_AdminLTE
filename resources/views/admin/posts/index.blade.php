    ...
    <div class="row">
            ...
            <div class="card shadow-sm">
                ...
                <div class="list-group list-group-flush">
                    <a href="{{ route('admin.posts.index') }}"
                       class="list-group-item list-group-item-action {{ request()->routeIs('admin.posts.index') ? 'bg-success text-white' : '' }}">
                        📄 Quản lý bài viết
                    </a>
        ...
        <div class="col-md-9">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h1 class="h4 mb-0">Quản lý bài viết</h1>
                <div>
                    <a href="{{ route('admin.posts.create') }}" class="btn btn-primary me-2">+ Tạo bài viết</a>
                        ...
                        @forelse ($posts as $index => $post)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.posts.show', $post->id) }}" class="btn btn-sm btn-info" target="_blank">👁 Xem</a>
                                    <a href="{{ route('admin.posts.edit', $post->id) }}" class="btn btn-sm btn-warning">✏️ Sửa</a>
